...
## Project Structure
    ...
    ├── testapiautotasksnew_90026  # Django project configurations
...
1. Clone this repo and `cd testapiautotasksnew_90026`
...
2. Clone this repo and `cd testapiautotasksnew_90026`
